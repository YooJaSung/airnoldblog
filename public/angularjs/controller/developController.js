...
angular.module('airnold.controller')
    .controller('developController', ['$scope','develop_manipulate','$window','$location','$routeParams','admin_login',
        function($scope, develop_manipulate, $window, $location,$routeParams,admin_login){
